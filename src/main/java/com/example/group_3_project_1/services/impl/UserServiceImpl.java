...
public class UserServiceImpl implements UserService {
	...
	private boolean isValideUserRequest(UserRequestDto userRequestDto) {
		return userRequestDto != null && userRequestDto.getCredentials() != null && userRequestDto.getProfile() != null
	...
	private boolean isValideCredentials(CredentialsDto credentialsDto) {
		return credentialsDto != null && credentialsDto.getUsername() != null && credentialsDto.getPassword() != null;
	}
	...
	private boolean isValideCredentialsAndUsername(CredentialsDto credentialsDto, String username) {
		return isValideCredentials(credentialsDto) && isValideUsername(username);
	}
	...
	public List<TweetResponseDto> getMentions(String username) {
		...
		return tweetMapper
				.entitiesToResponseDtos(getFilteredAndSortedTweets(getUserByUsername(username).getMentionedTweets()));
	}
	...
	public UserResponseDto updateUser(String username, UserRequestDto userRequestDto) {
		...
		User userInRepo = getUserByUsernameAndPassword(userRequestDto.getCredentials().getUsername(),
	...
	public UserResponseDto createUser(UserRequestDto userRequestDto) {
		...
		Optional<User> optionalUser = userRepository
				.findByCredentials_Username(userRequestDto.getCredentials().getUsername());
		...
		return userMapper
				.entityToResponseDto(userRepository.saveAndFlush(userMapper.requestDtoToEntity(userRequestDto)));
	}
